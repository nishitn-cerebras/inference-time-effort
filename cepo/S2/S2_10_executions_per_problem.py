...
async def process_batch(batch_data, batch_number, output_dir, problem_ids_file, client, model):
    ...
    # Write batch results
    batch_filename = os.path.join(output_dir, f"problem_{batch_number}.jsonl")
...
async def main():
    ...
    output_dir = "/mlf-transfers-only/nishitn/inference_time_effort/cepo/NuminaMath/gemini_generated_s2_data_10_executions_per_problem/"
